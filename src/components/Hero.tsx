...
export const Hero = () => {
  ...
  return (
    <div className="flex flex-col gap-3 m-auto justify-center text-center">
      ...
      <p ref={textRef} className="text-2xl md:text-3xl px-4 font-bold text-foreground/80 h-8" />
      <p className="text-2xl md:text-3xl px-4 font-bold text-foreground/80">Always here to help.</p>
